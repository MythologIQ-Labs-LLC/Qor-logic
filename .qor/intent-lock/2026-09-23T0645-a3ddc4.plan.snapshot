...
Recomposition of the same fix from superseded PR #493 (sealed against stale
base `f3e069b`, independently claimed the `0.174.1` release slot PR #492 has
since landed) onto current `main` (`d37c192c`), per the reconciliation
comment on #493.
