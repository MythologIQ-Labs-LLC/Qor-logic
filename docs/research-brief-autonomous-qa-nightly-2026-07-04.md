...
- **Dry-run threading** (D:\Accountable\Orko\poll.py lines 196, 224-243): reads always execute; writes/state-advance/notifications guarded by `if not dry_run`; log lines carry a `[dry]` prefix.
