...
**Phase**: Phase 218 (feature; unreconciled-record cluster; v0.141.0; closes GH #313, #316, #318, #321 under umbrella #319). Four governance checks were returning success on input they exist to catch. A failing check is a working control; a passing check on bad input certifies the defect.
