...
**Phase**: Phase 290 (feature; a verifier reports what it examined, and examining nothing is not a pass; v0.174.0). Three gates reported success over a scope that was empty, partial, or supplied by the party they audit, and nothing in the result said so.
