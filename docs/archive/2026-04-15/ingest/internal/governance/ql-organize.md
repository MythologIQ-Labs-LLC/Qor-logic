...
6. **ISOLATION MANDATORY** — `.agent/`, `.claude/`, `.qorelogic/`, `<consumer-governance-dotdir>/` are NEVER reorganized
...
Isolation rules: `.claude/commands/references/ql-organize-templates.md`.
...
Archetype definitions: `.claude/commands/references/ql-organize-templates.md`.
...
Convention checks: `.claude/commands/references/ql-organize-templates.md`.
...
Proposal template: `.claude/commands/references/ql-organize-templates.md`.
...
Template: `.claude/commands/references/ql-organize-templates.md`.
...
Privacy patterns: `.claude/commands/references/ql-organize-templates.md`.
...
- **NEVER** reorganize workspace governance directories (`.agent/`, `.claude/`, `.qorelogic/`, `<consumer-governance-dotdir>/`)
