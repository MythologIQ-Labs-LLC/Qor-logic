---
name: ql-research
description: Deep research phase for investigating external codebases, APIs, and dependencies before implementation. Use when you need to verify actual interfaces, discover recent changes, or build accurate integration knowledge.
---
...
```
Read: <legacy-staging>/META_LEDGER.md (verify chain state)
Read: <legacy-staging>/ARCHITECTURE_PLAN.md (understand what we're building)
Read: a legacy bridge memory file (existing knowledge to verify/update)
```
