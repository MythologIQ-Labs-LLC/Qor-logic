...
You have a persistent Persistent Agent Memory directory at `a sibling repository's .claude\agent-memory\qor-ultimate-debugger\`. Its contents persist across conversations.
