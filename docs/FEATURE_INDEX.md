...
| FX027 | `qor-logic scripts roadmap_cli` experimental Roadmap pilot | qor/scripts/roadmap_cli.py | qor/skills/meta/qor-roadmap/SKILL.md | tests/test_roadmap_cli.py::test_vertical_pilot_across_fresh_loads | verified |
