...
See Step 0.3 (line ~80) for plan-iteration ABORT, Step 3 (line ~209) for the binding-VETO inventory and per-pass detail, and the Constraints section at file foot for the post-batch-1 contract inventory.
