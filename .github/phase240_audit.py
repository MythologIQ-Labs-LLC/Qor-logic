...
TARGET = "3dd51126ac9120666f177c77164aa0605d551bc9"  # rebased product head incl. slack recovery
...
def assert_harness_only() -> None:
    ...
    expected = {".github/phase240_audit.py"}  # local-only harness; CI workflow retired
...
"""
    ...
    manifest = ai_provenance.build_manifest(
        "audit", host="claude-code", model_family="claude",
